...
namespace ElementEditor.classes
{
    ...
    public class Helper
    {
        ...
        public static Dictionary<int, List_RealList> list_supdype = new Dictionary<int, List_RealList>()
        {
        ...
        public static Dictionary<int, SubTypeElement> subtypesInfolist = null;

        public static Dictionary<int, string> classMasksID = new Dictionary<int, string>()
        {
             {1, "BladeMaster"},
             {2, "Wizard"},
             {4, "Psychic"},
        ...
        public static Dictionary<string, int> classMasksName = new Dictionary<string, int>()
        {
             {"BladeMaster", 1},
             {"Wizard", 2},
             {"Psychic", 4},
