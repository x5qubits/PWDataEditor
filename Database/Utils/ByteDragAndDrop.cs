...
{
    public class ByteDragAndDrop : DataObject, System.Runtime.InteropServices.ComTypes.IDataObject
    {
        public byte[] datax = null;
        public string name = null;
        public ByteDragAndDrop(byte[] selectedItems, string saveName)
        {
            datax = selectedItems;
            name = saveName;
        }
        ...
        public override object GetData(string format, bool autoConvert)
        {
            ...
            {
                base.SetData(NativeMethods.CFSTR_FILECONTENTS, datax);
            }
